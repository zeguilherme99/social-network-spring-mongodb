...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO c1 = new CommentDTO("Boa viagem, mano!", Instant.parse("2023-01-23T20:53:07Z"), new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveite", Instant.parse("2023-01-23T20:53:07Z"), new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", Instant.parse("2023-01-23T20:53:07Z"), new AuthorDTO(alex));
